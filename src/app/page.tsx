	...
	return (
		<Container className="py-12">
			<div className="size-full flex-c justify-center items-center gap-8">
				...
				<Link
					href="/menu"
					className="text-white text-xl border border-primary py-1 px-3 rounded-lg hover:bg-primary transition"
				>
					القائمة
				</Link>
				...
				<div className="flex-center flex-col gap-5">
					<div className="flex items-center gap-2">
						<Link href={socials.instagram} className="hover:text-primary transition" target="_blank">
							<FaInstagram size={30} />
						</Link>
						<Link href={socials.facebook} className="hover:text-primary transition" target="_blank">
							<FaFacebookF size={30} />
						</Link>
					</div>
